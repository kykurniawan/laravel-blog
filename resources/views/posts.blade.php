...
<div class="card mb-3">
    ...
    <div style="max-height:400px; overflow:hidden;">
        <img src="{{asset('storage/' . $posts[0]->image)}}" alt="{{$posts[0]->category->name}}" class="img-fluid w-100 mt-3">
    </div>
    @else
    ...
    <div class="col-md-4 mb-3">
        <div class="card h-100">
            <div class="position-absolute p-2 text-white" style="background-color: rgba(0, 0, 0, 0.7);">
                <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-white text-decoration-none">
                    {{$post->category->name}}
                </a>
            </div>
